...
ARM GAS  /tmp/ccdr33im.s 			page 2
  ...
  94 0004 83B0     		sub	sp, sp, #12
  95 0006 089F     		ldr	r7, [sp, #32]
  96 0008 099E     		ldr	r6, [sp, #36]
  97 000a 0097     		str	r7, [sp]
  98 000c 0196     		str	r6, [sp, #4]
  99 000e 0D46     		mov	r5, r1
 100 0010 FFF7FEFF 		bl	_ZN9UARTClassC2EP4Uart4IRQnmP10RingBufferS4_
 101 0014 2046     		mov	r0, r4
 102 0016 024B     		ldr	r3, .L8
 103 0018 6562     		str	r5, [r4, #36]
 104 001a 2360     		str	r3, [r4]
 105 001c 03B0     		add	sp, sp, #12
 106              		@ sp needed
 107 001e F0BD     		pop	{r4, r5, r6, r7, pc}
 108              	.L9:
 109              		.align	2
 110              	.L8:
