ARM GAS  /tmp/ccvQS1sw.s 			page 1
  ...
  29              	.L2:
  30 0008 001A0E40 		.word	1074665984
  31              		.size	Reset, .-Reset
  ...
  55 000a 4FF40024 		mov	r4, #524288
  56 000e 0C4B     		ldr	r3, .L10
  57 0010 0C4E     		ldr	r6, .L10+4
ARM GAS  /tmp/ccvQS1sw.s 			page 2


  58 0012 0D4D     		ldr	r5, .L10+8
  59 0014 1A70     		strb	r2, [r3]
  60              	.L5:
  61 0016 3046     		mov	r0, r6
  62 0018 FFF7FEFF 		bl	wdt_restart
  63 001c 0023     		movs	r3, #0
  64 001e 04F1FF01 		add	r1, r4, #255
  65 0022 2046     		mov	r0, r4
  66 0024 1A46     		mov	r2, r3
  67 0026 04F58074 		add	r4, r4, #256
  ...
  81 0044 501A0E40 		.word	1074666064
  82 0048 00011000 		.word	1048832
  83 004c 001A0E40 		.word	1074665984
