...
ARM GAS  /tmp/cc7BZ5n5.s 			page 10
...
ARM GAS  /tmp/cc7BZ5n5.s 			page 11
...
ARM GAS  /tmp/cc7BZ5n5.s 			page 12
...
ARM GAS  /tmp/cc7BZ5n5.s 			page 13
...
ARM GAS  /tmp/cc7BZ5n5.s 			page 14
 ...
 757 0332 0422     		movs	r2, #4
 758 0334 2D49     		ldr	r1, .L247+4
 759              	.L155:
 760 0336 2E4E     		ldr	r6, .L247+8
 761 0338 0023     		movs	r3, #0
 762 033a 3046     		mov	r0, r6
 763 033c 0139     		subs	r1, r1, #1
 764              	.L156:
 765 033e 0133     		adds	r3, r3, #1
 766 0340 11F8015F 		ldrb	r5, [r1, #1]!	@ zero_extendqisi2
 767 0344 DBB2     		uxtb	r3, r3
 768 0346 9A42     		cmp	r2, r3
 769 0348 20F8025F 		strh	r5, [r0, #2]!	@ movhi
 ...
 780 0360 D2B2     		uxtb	r2, r2
 781 0362 1968     		ldr	r1, [r3]
 782 0364 497C     		ldrb	r1, [r1, #17]	@ zero_extendqisi2
 ...
 789 0378 0222     		movs	r2, #2
 790 037a A368     		ldr	r3, [r4, #8]
...
ARM GAS  /tmp/cc7BZ5n5.s 			page 15
 ...
 806 039c 7268     		ldr	r2, [r6, #4]
 807 039e 03F10053 		add	r3, r3, #536870912
 808 03a2 013B     		subs	r3, r3, #1
 809 03a4 52F83310 		ldr	r1, [r2, r3, lsl #3]
 810 03a8 134F     		ldr	r7, .L247+16
...
ARM GAS  /tmp/cc7BZ5n5.s 			page 16
 ...
 868              		.section	.bss.udc_ep_status.7538,"aw",%nobits
 869              		.align	1
 870              		.set	.LANCHOR9,. + 0
 871              		.type	udc_ep_status.7538, %object
 872              		.size	udc_ep_status.7538, 2
 873              	udc_ep_status.7538:
 ...
 911      00000000 
ARM GAS  /tmp/cc7BZ5n5.s 			page 17
