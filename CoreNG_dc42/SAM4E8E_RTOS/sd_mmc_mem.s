ARM GAS  /tmp/cc5QVI0P.s 			page 1
  ...
  14              		.section	.text.sd_mmc_test_unit_ready,"ax",%progbits
  15              		.align	1
  16              		.p2align 2,,3
  17              		.global	sd_mmc_test_unit_ready
  18              		.syntax unified
  19              		.thumb
  20              		.thumb_func
  21              		.fpu fpv4-sp-d16
  22              		.type	sd_mmc_test_unit_ready, %function
  23              	sd_mmc_test_unit_ready:
  24              		@ args = 0, pretend = 0, frame = 0
  25              		@ frame_needed = 0, uses_anonymous_args = 0
  26 0000 38B5     		push	{r3, r4, r5, lr}
  27 0002 0546     		mov	r5, r0
  28 0004 FFF7FEFF 		bl	sd_mmc_check
  29 0008 0128     		cmp	r0, #1
  30 000a 0DD0     		beq	.L7
  31 000c 07D3     		bcc	.L4
  32 000e 0228     		cmp	r0, #2
  33 0010 03D1     		bne	.L11
  34 0012 0A4B     		ldr	r3, .L13
  35 0014 0022     		movs	r2, #0
  36 0016 5A55     		strb	r2, [r3, r5]
  37 0018 38BD     		pop	{r3, r4, r5, pc}
  38              	.L11:
  39 001a 0120     		movs	r0, #1
  40 001c 38BD     		pop	{r3, r4, r5, pc}
  41              	.L4:
  42 001e 074B     		ldr	r3, .L13
  43 0020 5C5D     		ldrb	r4, [r3, r5]	@ zero_extendqisi2
  44 0022 1CB1     		cbz	r4, .L12
  45              	.L6:
  46 0024 0220     		movs	r0, #2
  47 0026 38BD     		pop	{r3, r4, r5, pc}
  48              	.L7:
  49 0028 0320     		movs	r0, #3
  50 002a 38BD     		pop	{r3, r4, r5, pc}
  51              	.L12:
  52 002c 2846     		mov	r0, r5
  53 002e FFF7FEFF 		bl	sd_mmc_get_type
  54 0032 8307     		lsls	r3, r0, #30
  55 0034 F6D0     		beq	.L6
  56 0036 2046     		mov	r0, r4
  57 0038 38BD     		pop	{r3, r4, r5, pc}
ARM GAS  /tmp/cc5QVI0P.s 			page 2
...
ARM GAS  /tmp/cc5QVI0P.s 			page 6
 ...
 340 0020 08B1     		cbz	r0, .L43
 341 0022 0120     		movs	r0, #1
 342 0024 38BD     		pop	{r3, r4, r5, pc}
ARM GAS  /tmp/cc5QVI0P.s 			page 7
...
ARM GAS  /tmp/cc5QVI0P.s 			page 9
 ...
 481              		.ident	"GCC: (15:6.3.1+svn253039-1build1) 6.3.1 20170620"
