...
ARM GAS  /tmp/ccnvwTDH.s 			page 3
 ...
 158 002a D0F80052 		ldr	r5, [r0, #512]
 159 002e 4155     		strb	r1, [r0, r5]
 160 0030 0223     		movs	r3, #2
...
ARM GAS  /tmp/ccnvwTDH.s 			page 4
 ...
 224 0004 D3F80412 		ldr	r1, [r3, #516]
 225 0008 10B5     		push	{r4, lr}
 226 000a 0446     		mov	r4, r0
 227 000c C3F80012 		str	r1, [r3, #512]
 228 0010 D369     		ldr	r3, [r2, #28]
ARM GAS  /tmp/ccnvwTDH.s 			page 5


 229 0012 9847     		blx	r3
 230 0014 94F91C30 		ldrsb	r3, [r4, #28]
 231 0018 0748     		ldr	r0, .L32
 232 001a 5A09     		lsrs	r2, r3, #5
 233 001c 2032     		adds	r2, r2, #32
 234 001e 03F01F03 		and	r3, r3, #31
 235 0022 0121     		movs	r1, #1
...
ARM GAS  /tmp/ccnvwTDH.s 			page 6
 ...
 312 0002 4FF47A77 		mov	r7, #1000
 313 0006 074E     		ldr	r6, .L47
 314 0008 049D     		ldr	r5, [sp, #16]
 315 000a 8161     		str	r1, [r0, #24]
 316 000c 0277     		strb	r2, [r0, #28]
 317 000e 0599     		ldr	r1, [sp, #20]
 318 0010 8760     		str	r7, [r0, #8]
 319 0012 0022     		movs	r2, #0
 320 0014 0660     		str	r6, [r0]
 321 0016 0561     		str	r5, [r0, #16]
 322 0018 0362     		str	r3, [r0, #32]
 323 001a 4161     		str	r1, [r0, #20]
 324 001c 4260     		str	r2, [r0, #4]
 325 001e C260     		str	r2, [r0, #12]
...
ARM GAS  /tmp/ccnvwTDH.s 			page 7
 ...
 349 0006 006A     		ldr	r0, [r0, #32]
 350 0008 0D46     		mov	r5, r1
 351 000a 9046     		mov	r8, r2
 352 000c FFF7FEFF 		bl	pmc_enable_periph_clk
 353 0010 184B     		ldr	r3, .L51
 354 0012 94F91C20 		ldrsb	r2, [r4, #28]
 355 0016 1968     		ldr	r1, [r3]
 356 0018 A369     		ldr	r3, [r4, #24]
 357 001a 2769     		ldr	r7, [r4, #16]
 358 001c 6669     		ldr	r6, [r4, #20]
 359 001e DFF858E0 		ldr	lr, .L51+4
 360 0022 2C01     		lsls	r4, r5, #4
 361 0024 AC20     		movs	r0, #172
 362 0026 40F20225 		movw	r5, #514
 363 002a C3F82051 		str	r5, [r3, #288]
 364 002e 02F01F0C 		and	ip, r2, #31
 365 0032 1860     		str	r0, [r3]
 366 0034 5509     		lsrs	r5, r2, #5
 367 0036 0139     		subs	r1, r1, #1
 368 0038 0022     		movs	r2, #0
 369 003a 0120     		movs	r0, #1
 370 003c C3F80480 		str	r8, [r3, #4]
 371 0040 01EB5401 		add	r1, r1, r4, lsr #1
 372 0044 00FA0CF0 		lsl	r0, r0, ip
 373 0048 B1FBF4F1 		udiv	r1, r1, r4
 374 004c 4FF0FF34 		mov	r4, #-1
 375 0050 1962     		str	r1, [r3, #32]
 376 0052 C7F80422 		str	r2, [r7, #516]
 377 0056 6121     		movs	r1, #97
 378 0058 C7F80022 		str	r2, [r7, #512]
 379 005c C6F80422 		str	r2, [r6, #516]
 380 0060 C6F80022 		str	r2, [r6, #512]
 381 0064 5022     		movs	r2, #80
 382 0066 DC60     		str	r4, [r3, #12]
 383 0068 9960     		str	r1, [r3, #8]
 384 006a 4EF82500 		str	r0, [lr, r5, lsl #2]
 385 006e 1A60     		str	r2, [r3]
 386 0070 BDE8F081 		pop	{r4, r5, r6, r7, r8, pc}
 387              	.L52:
 388              		.align	2
 389              	.L51:
 390 0074 00000000 		.word	SystemCoreClock
 391 0078 00E100E0 		.word	-536813312
...
ARM GAS  /tmp/ccnvwTDH.s 			page 8
 ...
 440 0006 01F00F01 		and	r1, r1, #15
 ...
 450 0022 1A44     		add	r2, r2, r3
 451 0024 0901     		lsls	r1, r1, #4
 452 0026 1176     		strb	r1, [r2, #24]
 453 0028 7047     		bx	lr
 454              	.L60:
 455 002a 00BF     		.align	2
 456              	.L59:
ARM GAS  /tmp/ccnvwTDH.s 			page 9
 ...
 513 0018 7047     		bx	lr
ARM GAS  /tmp/ccnvwTDH.s 			page 10
 ...
 529 0002 5369     		ldr	r3, [r2, #20]
 530 0004 70B4     		push	{r4, r5, r6}
 ...
 564 005c 0169     		ldr	r1, [r0, #16]
 565 005e 4FF48073 		mov	r3, #256
...
ARM GAS  /tmp/ccnvwTDH.s 			page 11


 571 0072 9342     		cmp	r3, r2
 572 0074 07D0     		beq	.L76
 573 0076 D1F80022 		ldr	r2, [r1, #512]
 574 007a 7F20     		movs	r0, #127
 ...
 579 0084 7047     		bx	lr
 580              	.L76:
 581 0086 D1F80032 		ldr	r3, [r1, #512]
 582 008a 013B     		subs	r3, r3, #1
 583 008c C3F30803 		ubfx	r3, r3, #0, #9
 584 0090 7F22     		movs	r2, #127
 ...
 591 009c DBE7     		b	.L73
 592              	.L72:
 593 009e D4F80012 		ldr	r1, [r4, #512]
 594 00a2 0139     		subs	r1, r1, #1
 595 00a4 C1F30801 		ubfx	r1, r1, #0, #9
 596 00a8 7F25     		movs	r5, #127
...
ARM GAS  /tmp/ccnvwTDH.s 			page 12
