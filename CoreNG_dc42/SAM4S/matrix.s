ARM GAS  /tmp/cceLDZdD.s 			page 1
  ...
  26 0002 52F82030 		ldr	r3, [r2, r0, lsl #2]
  ...
  38              	.L3:
  39 001c 00020E40 		.word	1074659840
  ...
  55 0002 53F82030 		ldr	r3, [r3, r0, lsl #2]
  56 0006 82B0     		sub	sp, sp, #8
  57 0008 03F00703 		and	r3, r3, #7
ARM GAS  /tmp/cceLDZdD.s 			page 2
  ...
  66              	.L7:
  67 0018 00020E40 		.word	1074659840
  ...
  83 0002 03EB8000 		add	r0, r3, r0, lsl #2
  84 0006 82B0     		sub	sp, sp, #8
  85 0008 036C     		ldr	r3, [r0, #64]
  86 000a 23F0FF03 		bic	r3, r3, #255
  87 000e 0193     		str	r3, [sp, #4]
  88 0010 019B     		ldr	r3, [sp, #4]
  89 0012 C9B2     		uxtb	r1, r1
  ...
  96              		.align	2
  97              	.L11:
  98 001c 00020E40 		.word	1074659840
 ...
 113 0000 1030     		adds	r0, r0, #16
 114 0002 044B     		ldr	r3, .L15
ARM GAS  /tmp/cceLDZdD.s 			page 3
 ...
 124              		.align	2
 125              	.L15:
 126 0014 00020E40 		.word	1074659840
 ...
 142 0002 03EB8000 		add	r0, r3, r0, lsl #2
 143 0006 82B0     		sub	sp, sp, #8
 ...
 155              	.L19:
 156 001c 00020E40 		.word	1074659840
...
ARM GAS  /tmp/cceLDZdD.s 			page 4


 172 0002 054B     		ldr	r3, .L23
 ...
 183              	.L23:
 184 0018 00020E40 		.word	1074659840
 ...
 200 0002 03EB8000 		add	r0, r3, r0, lsl #2
 201 0006 82B0     		sub	sp, sp, #8
 202 0008 036C     		ldr	r3, [r0, #64]
 203 000a 23F4E013 		bic	r3, r3, #1835008
 204 000e 0193     		str	r3, [sp, #4]
 205 0010 019B     		ldr	r3, [sp, #4]
 206 0012 8904     		lsls	r1, r1, #18
 ...
 214              		.align	2
 215              	.L27:
 216 0020 00020E40 		.word	1074659840
...
ARM GAS  /tmp/cceLDZdD.s 			page 5


 229              		@ frame_needed = 0, uses_anonymous_args = 0
 230              		@ link register save eliminated.
 231 0000 1030     		adds	r0, r0, #16
 232 0002 054B     		ldr	r3, .L31
 ...
 243              		.align	2
 244              	.L31:
 245 0018 00020E40 		.word	1074659840
 ...
 261 0002 03EB8000 		add	r0, r3, r0, lsl #2
 ...
 274              	.L35:
 275 001c 00020E40 		.word	1074659840
...
ARM GAS  /tmp/cceLDZdD.s 			page 6
 ...
 290 0000 1030     		adds	r0, r0, #16
 291 0002 054B     		ldr	r3, .L39
 ...
 302              	.L39:
 303 0018 00020E40 		.word	1074659840
 ...
 322              		.align	2
 323              	.L42:
 324 0008 80020E40 		.word	1074659968
 ...
 341 0006 7047     		bx	lr
 342              	.L46:
ARM GAS  /tmp/cceLDZdD.s 			page 7


 343              		.align	2
 344              	.L45:
 345 0008 80020E40 		.word	1074659968
 346              		.size	matrix_get_slave_priority, .-matrix_get_slave_priority
 347              		.section	.text.matrix_set_system_io,"ax",%progbits
 348              		.align	1
 349              		.p2align 2,,3
 350              		.global	matrix_set_system_io
 351              		.syntax unified
 352              		.thumb
 353              		.thumb_func
 354              		.fpu softvfp
 355              		.type	matrix_set_system_io, %function
 356              	matrix_set_system_io:
 357              		@ args = 0, pretend = 0, frame = 0
 358              		@ frame_needed = 0, uses_anonymous_args = 0
 359              		@ link register save eliminated.
 360 0000 014B     		ldr	r3, .L48
 361 0002 C3F81401 		str	r0, [r3, #276]
 362 0006 7047     		bx	lr
 363              	.L49:
 364              		.align	2
 365              	.L48:
 366 0008 00020E40 		.word	1074659840
 367              		.size	matrix_set_system_io, .-matrix_set_system_io
 368              		.section	.text.matrix_get_system_io,"ax",%progbits
 369              		.align	1
 370              		.p2align 2,,3
 371              		.global	matrix_get_system_io
 372              		.syntax unified
 373              		.thumb
 374              		.thumb_func
 375              		.fpu softvfp
 376              		.type	matrix_get_system_io, %function
 377              	matrix_get_system_io:
 378              		@ args = 0, pretend = 0, frame = 0
 379              		@ frame_needed = 0, uses_anonymous_args = 0
 380              		@ link register save eliminated.
 381 0000 014B     		ldr	r3, .L51
 382 0002 D3F81401 		ldr	r0, [r3, #276]
 383 0006 7047     		bx	lr
 384              	.L52:
 385              		.align	2
 386              	.L51:
 387 0008 00020E40 		.word	1074659840
 388              		.size	matrix_get_system_io, .-matrix_get_system_io
 389              		.section	.text.matrix_set_nandflash_cs,"ax",%progbits
 390              		.align	1
 391              		.p2align 2,,3
 392              		.global	matrix_set_nandflash_cs
 393              		.syntax unified
 394              		.thumb
 395              		.thumb_func
 396              		.fpu softvfp
 397              		.type	matrix_set_nandflash_cs, %function
 398              	matrix_set_nandflash_cs:
 399              		@ args = 0, pretend = 0, frame = 0
ARM GAS  /tmp/cceLDZdD.s 			page 8


 400              		@ frame_needed = 0, uses_anonymous_args = 0
 401              		@ link register save eliminated.
 402 0000 014B     		ldr	r3, .L54
 403 0002 C3F81C01 		str	r0, [r3, #284]
 404 0006 7047     		bx	lr
 405              	.L55:
 406              		.align	2
 407              	.L54:
 408 0008 00020E40 		.word	1074659840
 409              		.size	matrix_set_nandflash_cs, .-matrix_set_nandflash_cs
 410              		.section	.text.matrix_get_nandflash_cs,"ax",%progbits
 411              		.align	1
 412              		.p2align 2,,3
 413              		.global	matrix_get_nandflash_cs
 414              		.syntax unified
 415              		.thumb
 416              		.thumb_func
 417              		.fpu softvfp
 418              		.type	matrix_get_nandflash_cs, %function
 419              	matrix_get_nandflash_cs:
 420              		@ args = 0, pretend = 0, frame = 0
 421              		@ frame_needed = 0, uses_anonymous_args = 0
 422              		@ link register save eliminated.
 423 0000 014B     		ldr	r3, .L57
 424 0002 D3F81C01 		ldr	r0, [r3, #284]
 425 0006 7047     		bx	lr
 426              	.L58:
 427              		.align	2
 428              	.L57:
 429 0008 00020E40 		.word	1074659840
 430              		.size	matrix_get_nandflash_cs, .-matrix_get_nandflash_cs
 ...
 454              		.align	2
 455              	.L64:
 456 0014 00020E40 		.word	1074659840
ARM GAS  /tmp/cceLDZdD.s 			page 9
 ...
 477              		.align	2
 478              	.L67:
 479 0008 00020E40 		.word	1074659840
