...
ARM GAS  /tmp/ccbyQIyX.s 			page 4
 ...
 209 0000 01F00F03 		and	r3, r1, #15
 210 0004 4168     		ldr	r1, [r0, #4]
 211 0006 21F00F01 		bic	r1, r1, #15
 212 000a 1943     		orrs	r1, r1, r3
 213 000c 4160     		str	r1, [r0, #4]
 214 000e 7047     		bx	lr
...
ARM GAS  /tmp/ccbyQIyX.s 			page 5


 229 0000 01F4E063 		and	r3, r1, #1792
 230 0004 4168     		ldr	r1, [r0, #4]
 231 0006 21F4E061 		bic	r1, r1, #1792
 232 000a 1943     		orrs	r1, r1, r3
 233 000c 4160     		str	r1, [r0, #4]
 234 000e 7047     		bx	lr
