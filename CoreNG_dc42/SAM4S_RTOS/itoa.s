...
ARM GAS  /tmp/cc60X6K0.s 			page 2
  ...
  69 004c 6C1E     		subs	r4, r5, #1
  70 004e 1A46     		mov	r2, r3
  71              	.L12:
  72 0050 12F8010D 		ldrb	r0, [r2, #-1]!	@ zero_extendqisi2
  73 0054 04F8010F 		strb	r0, [r4, #1]!
  74 0058 B242     		cmp	r2, r6
  ...
  88 006e 0A70     		strb	r2, [r1]
  89 0070 4D1C     		adds	r5, r1, #1
  90 0072 E9E7     		b	.L10
  91              	.L25:
...
ARM GAS  /tmp/cc60X6K0.s 			page 3
 ...
 163 003e 4C1E     		subs	r4, r1, #1
 164 0040 1A46     		mov	r2, r3
 165              	.L38:
 166 0042 12F8010D 		ldrb	r0, [r2, #-1]!	@ zero_extendqisi2
 167 0046 04F8010F 		strb	r0, [r4, #1]!
 168 004a B242     		cmp	r2, r6
 169 004c F9D1     		bne	.L38
 170 004e 9B1A     		subs	r3, r3, r2
 171 0050 0B44     		add	r3, r3, r1
ARM GAS  /tmp/cc60X6K0.s 			page 4
