ARM GAS  /tmp/cchUkBfR.s 			page 1
  ...
  25 0000 1520     		movs	r0, #21
  26 0002 FFF7FEBF 		b	pmc_enable_periph_clk
  27              		.size	spi_enable_clock, .-spi_enable_clock
  28 0006 00BF     		.section	.text.spi_disable_clock,"ax",%progbits
  29              		.align	1
  30              		.p2align 2,,3
  31              		.global	spi_disable_clock
  32              		.syntax unified
  33              		.thumb
  34              		.thumb_func
  35              		.fpu softvfp
  36              		.type	spi_disable_clock, %function
  37              	spi_disable_clock:
  38              		@ args = 0, pretend = 0, frame = 0
  39              		@ frame_needed = 0, uses_anonymous_args = 0
  40              		@ link register save eliminated.
  41 0000 1520     		movs	r0, #21
  42 0002 FFF7FEBF 		b	pmc_disable_periph_clk
  43              		.size	spi_disable_clock, .-spi_disable_clock
  44 0006 00BF     		.section	.text.spi_set_peripheral_chip_select_value,"ax",%progbits
  45              		.align	1
  46              		.p2align 2,,3
  47              		.global	spi_set_peripheral_chip_select_value
  48              		.syntax unified
  49              		.thumb
  50              		.thumb_func
  51              		.fpu softvfp
  52              		.type	spi_set_peripheral_chip_select_value, %function
  53              	spi_set_peripheral_chip_select_value:
  54              		@ args = 0, pretend = 0, frame = 0
  55              		@ frame_needed = 0, uses_anonymous_args = 0
  56              		@ link register save eliminated.
  57 0000 4368     		ldr	r3, [r0, #4]
ARM GAS  /tmp/cchUkBfR.s 			page 2


  58 0002 23F47023 		bic	r3, r3, #983040
  59 0006 4360     		str	r3, [r0, #4]
  60 0008 4368     		ldr	r3, [r0, #4]
  61 000a 0904     		lsls	r1, r1, #16
  62 000c 01F47021 		and	r1, r1, #983040
  63 0010 1943     		orrs	r1, r1, r3
  64 0012 4160     		str	r1, [r0, #4]
  65 0014 7047     		bx	lr
  66              		.size	spi_set_peripheral_chip_select_value, .-spi_set_peripheral_chip_select_value
  67 0016 00BF     		.section	.text.spi_set_delay_between_chip_select,"ax",%progbits
  68              		.align	1
  69              		.p2align 2,,3
  70              		.global	spi_set_delay_between_chip_select
  71              		.syntax unified
  72              		.thumb
  73              		.thumb_func
  74              		.fpu softvfp
  75              		.type	spi_set_delay_between_chip_select, %function
  76              	spi_set_delay_between_chip_select:
  77              		@ args = 0, pretend = 0, frame = 0
  78              		@ frame_needed = 0, uses_anonymous_args = 0
  79              		@ link register save eliminated.
  80 0000 4368     		ldr	r3, [r0, #4]
  81 0002 23F07F43 		bic	r3, r3, #-16777216
  82 0006 4360     		str	r3, [r0, #4]
  83 0008 4368     		ldr	r3, [r0, #4]
  84 000a 43EA0161 		orr	r1, r3, r1, lsl #24
  85 000e 4160     		str	r1, [r0, #4]
  86 0010 7047     		bx	lr
  87              		.size	spi_set_delay_between_chip_select, .-spi_set_delay_between_chip_select
  88 0012 00BF     		.section	.text.spi_read,"ax",%progbits
  89              		.align	1
  90              		.p2align 2,,3
  91              		.global	spi_read
  92              		.syntax unified
  ...
  94              		.thumb_func
  95              		.fpu softvfp
  96              		.type	spi_read, %function
  97              	spi_read:
  98              		@ args = 0, pretend = 0, frame = 0
  99              		@ frame_needed = 0, uses_anonymous_args = 0
 100              		@ link register save eliminated.
 101 0000 10B4     		push	{r4}
 102 0002 43F69923 		movw	r3, #15001
 103 0006 01E0     		b	.L6
 104              	.L8:
 105 0008 013B     		subs	r3, r3, #1
 106 000a 0ED0     		beq	.L11
 107              	.L6:
 108 000c 0469     		ldr	r4, [r0, #16]
 109 000e E407     		lsls	r4, r4, #31
 110 0010 FAD5     		bpl	.L8
 111 0012 8368     		ldr	r3, [r0, #8]
 112 0014 4068     		ldr	r0, [r0, #4]
 113 0016 8007     		lsls	r0, r0, #30
 114 0018 03D4     		bmi	.L9
ARM GAS  /tmp/cchUkBfR.s 			page 3


 115              	.L10:
 116 001a 0020     		movs	r0, #0
 117 001c 0B80     		strh	r3, [r1]	@ movhi
 118 001e 10BC     		pop	{r4}
 119 0020 7047     		bx	lr
 120              	.L9:
 121 0022 C3F30340 		ubfx	r0, r3, #16, #4
 122 0026 1070     		strb	r0, [r2]
 123 0028 F7E7     		b	.L10
 124              	.L11:
 ...
 129              		.section	.text.spi_write,"ax",%progbits
 130              		.align	1
 131              		.p2align 2,,3
...
ARM GAS  /tmp/cchUkBfR.s 			page 5


 229              		@ frame_needed = 0, uses_anonymous_args = 0
 230              		@ link register save eliminated.
 231 0000 042A     		cmp	r2, #4
 232 0002 14D0     		beq	.L41
 233 0004 42B1     		cbz	r2, .L42
 234 0006 082A     		cmp	r2, #8
 235 0008 05D1     		bne	.L37
...
ARM GAS  /tmp/cchUkBfR.s 			page 7
 ...
 352 000e 44EA0363 		orr	r3, r4, r3, lsl #24
 353 0012 43EA0243 		orr	r3, r3, r2, lsl #16
 354 0016 0B63     		str	r3, [r1, #48]
 355 0018 10BC     		pop	{r4}
 356 001a 7047     		bx	lr
 ...
 371 0000 19B9     		cbnz	r1, .L55
 372 0002 044B     		ldr	r3, .L56
 373 0004 C0F8E430 		str	r3, [r0, #228]
 374 0008 7047     		bx	lr
 375              	.L55:
 376 000a 034B     		ldr	r3, .L56+4
...
ARM GAS  /tmp/cchUkBfR.s 			page 8
 ...
 411 0000 00       		.space	1
 412              		.ident	"GCC: (15:6.3.1+svn253039-1build1) 6.3.1 20170620"
