...
C_SRCS += \
../asf/common/services/clock/same70/sysclk.c 

OBJS += \
./asf/common/services/clock/same70/sysclk.o 

C_DEPS += \
./asf/common/services/clock/same70/sysclk.d 


# Each subdirectory must supply rules for building sources it contributes
asf/common/services/clock/same70/%.o: ../asf/common/services/clock/same70/%.c
	@echo 'Building file: $<'
